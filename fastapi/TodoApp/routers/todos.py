...
class TodoRequest(BaseModel): # tämä luokka määrittelee todo-tietueen vaatimukset
...
@router.get("/todo/{todo_id}", status_code=status.HTTP_200_OK) # tämä endpoint palauttaa yksittäisen todo-tietueen
...
async def update_todo(user: user_dependency, db: db_dependency,
    ...
    todo_model.title = todo_request.title # päivitetään todo-tietueet
